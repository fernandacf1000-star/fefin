  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 splash-float">
        <svg width="110" height="132" viewBox="0 0 100 120" fill="none">
          ...
          <g className="splash-coin-bounce">
            <circle cx="76" cy="88" r="10" fill="#F7D070" stroke="#E8B800" strokeWidth="1.5"/>
            <text x="76" y="92" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#B8860B">$</text>
          </g>
        </svg>
      </div>
